    ...
    <section id="inicio" className="relative min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden bg-[#faf9f6]">
      ...
      <div className="relative z-10 flex flex-col items-center px-4 max-w-4xl mx-auto text-center">
        <motion.div
          ...
          className="mb-8"
        >
          <CoinLogo src="/iniciais.png" alt="Logo Elaine Ferreira" />
        </motion.div>
        ...
        >
          ...
          <span className="text-gradient-brand">PARA SUA VIDA</span>
        </motion.h1>
        ...
        >
          Atendimento psicológico com acolhimento, escuta e estratégias práticas.<br />
        ...
        <motion.button
          ...
          className="mt-10 btn-primary text-white px-8 py-4 rounded text-sm font-bold tracking-widest transition-all hover:-translate-y-1"
        >
          AGENDAR CONSULTA
        </motion.button>
      </div>
      ...
      <motion.a 
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce text-gray-400 hover:text-brand-500 transition-colors"
      >
