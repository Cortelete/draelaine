    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="font-serif text-xl font-bold text-brand-400 mb-4">Psicóloga Elaine Ferreira</h3>
            <p className="text-gray-400 text-sm">Psicologia Clínica e Avaliação Neuropsicológica.</p>
          </div>
          <div>
            <h3 className="font-serif text-xl font-bold text-brand-400 mb-4">Contato</h3>
          ...
          <div>
            <h3 className="font-serif text-xl font-bold text-brand-400 mb-4">Redes Sociais</h3>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">© {new Date().getFullYear()} Elaine Ferreira Machado. Todos os direitos reservados.</p>
          <button 
